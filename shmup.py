...
class Player(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.image.set_colorkey(BLACK) # Elimina fondo negro de la imagen
		self.rect = self.image.get_rect() # Recta del Sprite
...
# Limitar el movimiento dentro de los márgenes de la ventana
...
# Definir clase de elementos de colisión
...
class Bullet(pygame.sprite.Sprite):
	def __init__(self, x, y):
		super().__init__()
		self.image = pygame.image.load("assets/laser-1.png")
		self.image.set_colorkey(BLACK)
		self.rect = self.image.get_rect()
		self.rect.y = y
		self.rect.centerx = x
